...
class Camera(nn.Module):
    def __init__(self, colmap_id, R, T, FoVx, FoVy, fx, fy, cx, cy, image, gt_alpha_mask,
        ...
        self.projection_matrix = getProjectionMatrixShift(self.znear, self.zfar, fx, fy, cx, cy, self.image_width, 
                                                          self.image_height, self.FoVx, self.FoVy).transpose(0, 1).cuda()
